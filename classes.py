...
class Nature:
    ...
    def draw(self, surf: SurfaceType):
        ...
        myfont = pygame.font.Font("misc/munro.ttf", 50)
        score = myfont.render(str(self.points).zfill(8), 1, pygame.color.THECOLORS["white"])
        surf.blit(score, (50, 30))
...
class Player(RectangularObject):
    ...
    def draw(self, surf: SurfaceType):
        pos = [210, 90]
        rot_sprite = pygame.transform.rotate(self.sprite, 90)
        for i in range (self.lives):
            surf.blit(rot_sprite, (pos[0], pos[1]))
            pos[0] -= 30
